      ...
      <div className="flex min-h-screen bg-gray-100">
        ...
        <div className="w-64 bg-blue-900 text-white shadow-lg flex flex-col">
          ...
          <nav className="mt-6 flex-1">
            <Link to="/command-center" className="flex items-center gap-3 px-6 py-4 hover:bg-blue-800 transition">
              <Globe size={20} /> {t('command_center')}
            </Link>
        ...
        <div className="flex-1 overflow-auto">
          ...
          <Routes>
            <Route path="/command-center" element={<NationalCommandCenter />} />
